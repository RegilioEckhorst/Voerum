namespace Voerum.Migrations
{
    ...
    public partial class FirstMigrations : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Beschrijving = c.String(maxLength: 1020, storeType: "nvarchar"),
                    })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.HasIngredients", "RecipesId", "dbo.Recipes");
            DropForeignKey("dbo.HasIngredients", "ingredientsId", "dbo.Ingredients");
            ...
            DropIndex("dbo.HasIngredients", new[] { "ingredientsId" });
            DropIndex("dbo.HasIngredients", new[] { "RecipesId" });
